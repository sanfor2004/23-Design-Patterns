...
| --- | --- | --- | --- | --- |
| [Abstract Factory](creational/abstract-factory/README.ar-EG.md) | Creational Pattern | استخدمه لما كذا نوع من المنتجات لازم يتغيروا مع بعض، والـ Client ماينفعش يختار الـ classes بنفسه. | بلاش لو عندك نوع واحد ثابت، أو لو الاختيارات المستقلة مطلوبة أصلاً. | Factory واحدة، طقم متوافق. |
| [Builder](creational/builder/README.ar-EG.md) | Creational Pattern | استخدمه لما الخيارات المستقلة كتير، أو محتاج نقطة واضحة لمراجعة الإنشاء. | بلاش مع معاملين واضحين؛ struct صغيرة ممكن تكون أبسط. | اختار الخطوات، وبعدها ابنِ. |
...
| [Singleton](creational/singleton/README.ar-EG.md) | Creational Pattern | فكّر فيه بس لو الـ instance الواحدة شرط حقيقي على مستوى العملية وعمرها مناسب. | بلاش لمجرد تسهيل الوصول للـ dependencies. مرّر Metrics reference صراحة لما الاختبارات محتاجة عزل. | instance واحدة مش معناها مشاكل أقل. |
...
| [Composite](structural/composite/README.ar-EG.md) | Structural Pattern | استخدمه لشجرة جزء وكل حقيقية، وعملية مفيدة تنفع للورقة والمجموعة. | بلاش لقائمة مسطحة أو Graph فيها مشاركة ودورات؛ tree ownership مش هتمثلها صح. | المجموعة بتجاوب زي عنصر. |
| [Decorator](structural/decorator/README.ar-EG.md) | Structural Pattern | استخدمه ل behavior اختياري قابل للتركيب وبيحافظ على عقد العنصر الأصلي. | بلاش لو قائمة مكونات وجمع أسعار كفاية؛ المثال متعمد عشان يوضح التركيب. | نفس العقد، وطبقة زيادة. |
...
| [State](behavioral/state/README.ar-EG.md) | Behavioral Pattern | استخدمه لما الـ behavior حسب الـ state والانتقالات يتوزعوا على كذا عملية. | بلاش لـ Toggle بسيطة أو جدول enum واضح وصغير. | نفس الـ event ، حالة مختلفة، رد مختلف. |
