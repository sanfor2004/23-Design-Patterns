...
cmake --build build --config Debug --target pattern_template_method
ctest --test-dir build -C Debug -R "^pattern_template_method$" --output-on-failure
```
