# Chain of Responsibility: C++20 example
...
cmake --build build --config Debug --target pattern_chain_of_responsibility
ctest --test-dir build -C Debug -R "^pattern_chain_of_responsibility$" --output-on-failure
```
