...
cmake --build build --config Debug --target pattern_factory_method
ctest --test-dir build -C Debug -R "^pattern_factory_method$" --output-on-failure
```
