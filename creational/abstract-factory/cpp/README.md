...
cmake --build build --config Debug --target pattern_abstract_factory
ctest --test-dir build -C Debug -R "^pattern_abstract_factory$" --output-on-failure
```
